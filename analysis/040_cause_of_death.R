...
write.table(table_allcauses_ch, file = "./output/tables/table_allcauses_ch.txt", sep = "\t", na = "", row.names=FALSE)

# private homes 
table_allcauses_ph <- map_dfr(file_list, ~cause_of_death_format(.x, care_home_filter = "N", remove_covid_deaths = "N"))
write.table(table_allcauses_ph, file = "./output/tables/table_allcauses_ph.txt", sep = "\t", na = "", row.names=FALSE)

##-- Without COVID deaths 
# care homes
table_nccauses_ch <- map_dfr(file_list, ~cause_of_death_format(.x, care_home_filter = "Y", remove_covid_deaths = "Y"))
write.table(table_nccauses_ch, file = "./output/tables/table_nccauses_ch.txt", sep = "\t", na = "", row.names=FALSE)

# private homes 
table_nccauses_ph <- map_dfr(file_list, ~cause_of_death_format(.x, care_home_filter = "N", remove_covid_deaths = "Y"))
write.table(table_nccauses_ph, file = "./output/tables/table_nccauses_ph.txt", sep = "\t", na = "", row.names=FALSE)
...
png(filename = "./output/plots/plot_allcauses_ch.png")
plot_allcauses_ch
dev.off()
...
png(filename = "./output/plots/plot_allcauses_ph.png")
plot_allcauses_ph
dev.off()
...
png(filename = "./output/plots/plot_nccauses_ch.png")
plot_nccauses_ch
dev.off()
...
png(filename = "./output/plots/plot_nccauses_ph.png")
plot_nccauses_ph
dev.off()
